...
public class LoginTest extends excel {
 ...
 Thread.sleep(10000);
 label="Pass";
 sheet.getRow(1).getCell(3).setCellValue(label);	
 Thread.sleep(3000);
	 }
 ...
 catch(Exception e)
 {
	...
	try {
		...
		String email="jmeter2005@gmail.com";
	   ...
	   // Assert.assertTrue(til.contains(email));
	    ...
	    sheet.getRow(2).getCell(3).setCellValue(label);		
	}
	 catch(Exception e) {
...
@Test(priority=3,description="Jobs Feed module test")
	public void JobsFeedTestCase() throws InterruptedException
	{
		try {
			...
			sheet.getRow(3).getCell(3).setCellValue(label);
			Thread.sleep(3000);
				    	...
				    	// System.out.println(i);
				    	 ...
				    	 if(!label_job.isDisplayed())
								...
								
				            {
				        			...
				        			sheet.getRow(5).getCell(3).setCellValue(label);
				        	    }
 	   ...
 	   else
				  {
				   ...
				   System.out.println(link);
					if(link.equalsIgnoreCase("Job page"))
						...
						{
							label="Fail";
							System.out.println("Selected Application has not been applied.");
						}
						
						}
					sheet.getRow(4).getCell(3).setCellValue(label);
			    } 
...
@Test(priority=4,description="application module test")
...
if(listview.isDisplayed())
{
		...
		String view2=objapp.getviewtil();
		   if(view2.equals(view1))
			...
			Thread.sleep(10000);
			objapp.clickappok();
			sheet.getRow(6).getCell(3).setCellValue(label);
...
@Test(priority=5,description="Interview tab test")
	public void InterviewTestCase()
	{
		...
		try {
			...
			*/
			...
			sheet.getRow(7).getCell(3).setCellValue(label);
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
@Test(priority=6,description="Offer tab test")
	public void OfferTestCase()
	{
		...
		try {
			...
			sheet.getRow(8).getCell(3).setCellValue(label);
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
@Test(priority=7,description="Job Search Module-Location Test Case")
public void JobSearchLocationTestCase() throws InterruptedException
{
	...
	try {
		...
		else
		{
			...
			sheet.getRow(9).getCell(3).setCellValue(label);
		...
		sheet.getRow(11).getCell(3).setCellValue(label);
	} catch (Exception e) {
		// TODO Auto-generated catch block
...
@Test(priority=8,description="Job Search module -Job Test Case")
public void JobSearchTestCase() throws InterruptedException
{
	...
	try {
		...
		else
		{
			...
			sheet.getRow(12).getCell(3).setCellValue(label);
	}
			catch (Exception e) {
				// TODO Auto-generated catch block
	  ...
	  try
	  {
		...
		sheet.getRow(13).getCell(3).setCellValue(label);
	} 
	  catch (Exception e) {
		// TODO Auto-generated catch block
...
@Test(priority=9,description="Job Search Module- Pay Test Case")
public void JobSearchpPayTestCase() throws InterruptedException
{
	try {
		...
		else
		{
			...
			sheet.getRow(14).getCell(3).setCellValue(label);
		Thread.sleep(2000);
		String title=objsearch.gettilejob();
		if(title.equals("Jobs"))
		{
		...
		sheet.getRow(15).getCell(3).setCellValue(label);
	} catch (Exception e) {
		// TODO Auto-generated catch block
...
@Test(priority=10,description="Training Module Test Case")
public void TrainingTestCase() throws InterruptedException
{
	try {
		...
		sheet.getRow(16).getCell(3).setCellValue(label);
	}
...

{
		...
		sheet.getRow(17).getCell(3).setCellValue(label);
     }
     ...
     try
     {
		...
		else
		{
			...
			sheet.getRow(18).getCell(3).setCellValue(label);
     }
    catch (Exception e) {
		// TODO Auto-generated catch block
...
@Test(priority=11,description="My Training Module Test Case")
public void MytTrainingTestCase() throws InterruptedException
{
	try {
		...
		else
		{
			...
			sheet.getRow(19).getCell(3).setCellValue(label);
		...
		if(list_train.isDisplayed())
		{
			...
			sheet.getRow(20).getCell(3).setCellValue(label);
		}
	} catch (Exception e) {
		// TODO Auto-generated catch block
...
@Test(priority=12,description="Wallet Module Test Case")
public void WalletTestCase() throws InterruptedException
{
	try {
		...
		sheet.getRow(21).getCell(3).setCellValue(label);
		Thread.sleep(2000);
		objwallet.clickadd();
		Thread.sleep(3000);
		...
		else
		{
			...
			sheet.getRow(22).getCell(3).setCellValue(label);					
...
@Test(priority=13,description="Settings Module Test Case")
public void SettingsTestCase() throws InterruptedException
{
	try {
		...
		else
		{
			...
			sheet.getRow(23).getCell(3).setCellValue(label);
		...
		else
		{
			...
			sheet.getRow(24).getCell(3).setCellValue(label);
	} catch (Exception e) {
		// TODO Auto-generated catch block
...
@Test(priority=14,description="Logout Test Case")
public void LogoutTestCase() throws InterruptedException
{
	...
	sheet.getRow(25).getCell(3).setCellValue(label);
}
...
@Test(priority=15,description="Forget Module Test Case")
public void ForgetTestCase()
{
	...
	objForget.forget("jmeter2009@gmail.com");
	...
	sheet.getRow(26).getCell(3).setCellValue(label);
}
...
//@Test(priority=16,description="Sign Up Test Case")
...
try {
	...
	sheet.getRow(27).getCell(3).setCellValue(label);
...
//@Test(priority=17,description="Logout Test Case")
public void LogoutTestCase2() throws InterruptedException
{
	try
	{
