...
public class ParallelTesting extends excel {
	...
	public void setup_server(String deviceName,String platformVersion ) throws IOException, InterruptedException
	{
	...
	// cap.setCapability("deviceName", "04157df411343e15");
     ...
     if(deviceName.equals("ce11171b65dd9c3a0c")) {
    	 cap.setCapability("platformVersion", platformVersion);
    	 driver = new AndroidDriver<MobileElement>(new URL("http://127.0.0.1:5001/wd/hub"), cap);
    	 Thread.sleep(3000);
     }
     if(deviceName.equals("10160a5273cd3302")) {
    	 cap.setCapability("platformVersion", platformVersion);
    	 driver = new AndroidDriver<MobileElement>(new URL("http://127.0.0.1:5000/wd/hub"), cap);
    	 Thread.sleep(3000);
     }
    /* else {
    	 cap.setCapability("platformVersion", "6.0");
    	 driver= new AndroidDriver<MobileElement>(new URL("http://127.0.0.1:4444/wd/hub"),cap);
    	 Thread.sleep(3000);
     }*/
	...
	try {
		...
		String email="jmeter12345@gmail.com";
...
//@Test(priority=18,description="Sign Up Test Case")
...
@Test(priority=4)
	public void ApplicationTestCase() throws InterruptedException
	{
		...
		try {
			...
			sheet.getRow(8).getCell(4).setCellValue(label);
			driver.manage().timeouts().implicitlyWait(4000,TimeUnit.SECONDS);
...
else
{
			...
			sheet.getRow(9).getCell(4).setCellValue(label);
		} catch (Exception e) {
			// TODO Auto-generated catch block
	...
	public void InterviewTestCase()
	{
		...
		try {
			...
			*/
			...
			sheet.getRow(11).getCell(4).setCellValue(label);
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
@Test(priority=6)
	public void OfferTestCase()
	{
		...
		try {
			...
			sheet.getRow(13).getCell(4).setCellValue(label);
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
public void JobSearchTestCase() throws InterruptedException
{
	...
	try {
	  ...
	  try
	  {
		...
		//objsearch.getrole();
		Thread.sleep(30000);
		MobileElement role_sel1=driver.findElement(objsearch.role_sel);
...

{
		...
		String price=driver.findElement(objtrain.price).getText();
		...
		year.click();
		 ((AndroidDeviceActionShortcuts) driver).pressKeyCode(AndroidKeyCode.KEYCODE_ENTER); // keyword next or enter btn
		objtrain.click_ok();
...
public void WalletTestCase() throws InterruptedException
{
	try {
		...
		else
		{
			...
			sheet.getRow(29).getCell(4).setCellValue(label);
		...
		else
		{
			...
			sheet.getRow(30).getCell(4).setCellValue(label);
			Thread.sleep(2000);
		//certificate
		...
		sheet.getRow(31).getCell(4).setCellValue(label);
	} catch (Exception e) {
		// TODO Auto-generated catch block
